...
transcription=tran_loader('data/AMHARIC/data/train/trsTrain.txt')
filenames, target,duration_of_recordings= meta_data(transcription,"data/AMHARIC/data/train/wav/")
metadata_df=pd.DataFrame({'file_name': filenames,'normalized_transcription': target})
...
"""
wavs_path = 'data/AMHARIC/data/train/wav'
batch_size = 32
